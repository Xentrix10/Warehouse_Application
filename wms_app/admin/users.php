									...
									<table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											<tr>
												...
												?>
													<td class="cell"> <?php echo $row_data['username']; ?> </td>
													<td class="cell"> <?php echo $row_data['password']; ?> </td>
													<td class="cell"><?php echo $row_data['userRole']; ?> </td>
													<td class="cell"><a class="btn-sm app-btn-secondary" href="admin-deleteUser.php?id=<?php echo $row_data["id"]; ?>">Delete</a></td>
											</tr>
										<?php
												}
										?>
