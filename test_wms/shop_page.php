...
<body>
  <div class="tm-container">
      ...
      <div class="tm-left">
        <div class="tm-left-inner">
          <div class="tm-site-header">
            ...
            <h1 class="tm-site-name"><?php echo $_SESSION['name'];?> DASHBOARD</h1>
          </div>
          <nav class="tm-site-nav">
            <ul class="tm-site-nav-ul">
              <li class="tm-page-nav-item">
                <a href="form1.php" class="tm-page-link active">
                  <i class="fas fa-mug-hot tm-page-link-icon"></i>
                  <span>ORDER COSMETICS</span>
                </a>
              </li>
              <li class="tm-page-nav-item">
    ...
    <footer class="tm-site-footer">
      <p class="tm-black-bg tm-footer-text">Copyright
      
      | Design: <a href="" class="tm-footer-link" rel="sponsored" target="_parent">Shop</a></p>
    </footer>
  </div>
